...
def parse_args(args=None):
    ...
    parser.add_argument('--data_path', type=str, default='F:\\tian\\DMMCS\\data\\FB15k')
    ...
    parser.add_argument('-save', '--save_path', default='F:\\tian\\DMMCS\\save\\FB15k\\new\\add_bias1', type=str)
